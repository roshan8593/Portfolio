  ...
  return (
    ...
    >
      ...
      <div className="relative">
        {/* Vertical Line */}
        <div className="absolute left-6 sm:left-1/2 sm:-translate-x-1/2 w-1 bg-white h-full"></div>
        ...
        {education.map((edu, index) => (
          ...
          >
            {/* Timeline Circle */}
            <div className="absolute left-6 sm:left-1/2 -translate-x-1/2 bg-gray-400 border-4 border-[#8245ec] w-12 h-12 sm:w-16 sm:h-16 rounded-full flex justify-center items-center z-10">
              <img
                src={edu.img}
                alt={edu.school}
